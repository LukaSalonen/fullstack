    ...
    <div>
      <Router>
        <div>
          ...
          <Route path="/create" render={() => <CreateNew addNew={props.addNew} createNotification={props.createNotification} />} />
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Menu anecdotes={anecdotes} addNew={addNew} anecdoteById={anecdoteById} createNotification={createNotification} />
      <Footer />
    </div>
  )
}
